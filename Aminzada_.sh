...
\e[92m               `-..-`    \e[93m└─┘└─┘└─┘ \e[92m└─┘'
echo
echo -e '            \e[92m::: Tool By Aminzada Hackers :::\e[0m'
echo -e '          \e[92m::: @Safiullah_Hacker :::\e[0m'
echo -e "\e[92m"
...
then
xdg-open https://t.me/BLACK_Hackers_Team_9192>/dev/null
elif [[ "$sit" = "5" || "$sit" = "five" ]];
then
xdg-open https://github.com/Aminzada_hackers 2>/dev/null
elif [[ "$sit" = "6" || "$sit" = "six" ]];
then
xdg-open https://t.me/BLACK_Hackers_Team_919> /dev/null 2>&1
elif [[ "$sit" = "7" || "$sit" = "seven" ]];
then
xdg-open https://wa.link/9we3dt> /dev/null 2>&1
...
echo -e '\e[92m IM NOT https://t.me/BLACK_Hackers_Team_919 IF YOU DO ANY ILLEGAL THINGS'
echo -e '\e[92m   THANKS FOR READING SUBSCRIBE {AMINZADA HACKERS}'
